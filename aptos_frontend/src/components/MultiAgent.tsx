...
export function MultiAgent() {
  ...
  const generateTransaction = async (): Promise<AnyRawTransaction> => {
    ...
    const secondarySigner:any = "0x99891379eaa29093a9c517790c75c6859f9dd7780b01e608bc9585bfd374ecec";

    // add fund to secondarySigner account
    /*
            ...
            <LabelValueGrid
              items={[
                ...
                */
                {
                  label: "Address",
                  value: secondarySignerAccount.toString(),
                },
              ]}
            />
          </div>
